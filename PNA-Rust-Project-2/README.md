...
- [PNA Rust Project 2: Log-structured file I/O](#pna-rust-project-2-log-structured-file-io)
  - [Introduction](#introduction)
  - [Terminology](#terminology)
  - [Project spec](#project-spec)
  - [Project setup](#project-setup)
  - [Part 1: Error handling](#part-1-error-handling)
  - [Part 2: How the log behaves](#part-2-how-the-log-behaves)
  - [Part 3: Writing to the log](#part-3-writing-to-the-log)
  - [Part 4: Reading from the log](#part-4-reading-from-the-log)
  - [Part 5: Storing log pointers in the index](#part-5-storing-log-pointers-in-the-index)
  - [Part 6: Stateless vs. stateful `KvStore`](#part-6-stateless-vs-stateful-kvstore)
  - [Part 7: Compacting the log](#part-7-compacting-the-log)
